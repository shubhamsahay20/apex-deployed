...
const orderData = [
  { article: "301", requirements: "BK ", size: "6X10", quantity: 120, type: "S/H", customer: "Warehouse 01" },
  { article: "401", requirements: "BK ", size: "6X10", quantity: 183, type: "S/H", customer: "Warehouse 02" },
  { article: "422", requirements: "BK ", size: "6X9", quantity: 122, type: "S", customer: "Warehouse 03" },
  { article: "356", requirements: "BK", size: "8X10", quantity: 90, type: "S", customer: "Warehouse 04" },
  { article: "786", requirements: "BK ", size: "6X9", quantity: 100, type: "H", customer: "Warehouse 05" },
];
        ...
        <>
          ...
          <div className="bg-white border border-gray-200 rounded shadow">
            <div className="p-4 flex justify-between items-center">
              <h3 className="text-lg font-semibold">Stock Availability Details</h3>
