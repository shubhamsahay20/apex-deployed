      ...
      <div className="bg-white rounded-lg border p-4 mb-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 p-1 divide-y-1 sm:divide-y-0 sm:divide-x">
          ...
          <div className="py-1">
            ...
            <p className="text-sm font-semibold text-gray-800">{accountData.totalRejected}</p>
          </div>
        </div>
      </div>
                ...
                <tr key={item._id} className="border-b hover:bg-gray-50">
                  ...
                  <td className="px-4 py-2 whitespace-nowrap">
                    <div className="flex items-center gap-3">
                      <FiEye className="text-green-600 w-4 h-4 cursor-pointer hover:scale-110 transition" />
                      <PiPencilSimpleLineBold className="text-blue-500 w-4 h-4 cursor-pointer hover:scale-110 transition" />
                      <FiTrash2 className="text-red-600 w-4 h-4 cursor-pointer hover:scale-110 transition" />
                    </div>
                  </td>
                </tr>
              ))}
