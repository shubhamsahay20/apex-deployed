        ...
        <div className="p-6 bg-[#F5F6FA] min-h-screen space-y-6">
            ...
            <div className="flex justify-between items-start">
                <div className="text-sm text-[#1F2937] w-full max-w-xl space-y-2">
                    <div className="grid grid-cols-2 gap-y-2">
                        ...
                        <p className="text-[#6B7280]">{state?.name || 'Warehouse 01'}</p>

                        <p className="text-[#6B7280] font-medium">Phone Number</p>
                        <p className="text-[#6B7280]">9923 345 876</p>
                ...
                <div className="flex gap-2">
                    <button className="px-4 py-1.5 border border-gray-300 rounded bg-white text-sm text-gray-700">Print</button>
                    <button className="px-4 py-1.5 border border-gray-300 rounded bg-white text-sm text-gray-700">PDF</button>
                </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow">
                <div className="flex justify-between items-center mb-4">
                    <h3 className="text-md font-semibold text-[#1F2937]">Stock Availability Details</h3>
                    <button className="px-4 py-1.5 bg-[#EEF2FF] text-[#1D4ED8] text-sm rounded">Print</button>
                </div>
                    ...
                    <tbody className="text-[#1F2937]">
                        {stockData.map((item, index) => (
                            <tr key={index} className="border-t hover:bg-[#F9FAFB]">
                                ...
                                <td className="p-3 text-center text-red-500 cursor-pointer" onClick={() => setDeleteIndex(index)}>🗑</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
            ...
            {deleteIndex !== null && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 backdrop-blur-sm px-4">
                    <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-sm relative animate-fade-in">
                        ...
                        <h2 className="text-lg font-semibold text-gray-800 mb-2">Delete Stock Item?</h2>
