...
const InternalDetails = () => {
    ...
    const handleCreateLabels = () => {
        navigate("/inventory/internal-label", { state });
    };

    return (
        <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
            <div className="flex justify-between items-center">
                <h2 className="text-lg font-semibold text-gray-800">Internal Transfer </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <select
                        ...
                        className="border px-4 py-2 rounded-md text-sm  w-full"
                    >
                        <option value="Warehouse 01">WareHouse  1</option>
