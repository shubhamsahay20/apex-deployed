        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button
              ...
              className="text-sm border px-3 py-1.5 rounded-md bg-blue-600 text-white font-medium hover:bg-blue-700 transition"
            >
              Add Article
            </button>
            <button className="text-sm border px-3 py-1.5 rounded-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-gray-700">
                  ...
                  <p>
                    <span className="font-semibold">Soft/Hard:</span>{' '}
                    {selectedArticle.softHard}
                  </p>
                  <p>
                    <span className="font-semibold">Stock Alert:</span> 20
                  </p>
                  <p>
